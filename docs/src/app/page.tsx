        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div className="group rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm transition-all hover:border-zinc-300 hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900/50 dark:hover:border-zinc-700">
              ...
              <p className="text-zinc-600 dark:text-zinc-400">Automatically extracts credentials from your installed desktop apps.</p>
            </div>
            <div className="group rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm transition-all hover:border-zinc-300 hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900/50 dark:hover:border-zinc-700">
              ...
              <p className="text-zinc-600 dark:text-zinc-400">Learn once, use everywhere. Unified commands for Slack, Discord, and Teams.</p>
            </div>
            <div className="group rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm transition-all hover:border-zinc-300 hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900/50 dark:hover:border-zinc-700">
              ...
              <p className="text-zinc-600 dark:text-zinc-400">JSON output by default. Perfect for LLM tool use and automation.</p>
            </div>
            <div className="group rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm transition-all hover:border-zinc-300 hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900/50 dark:hover:border-zinc-700">
              ...
              <p className="text-zinc-600 dark:text-zinc-400">CLI approach, not MCP. Load only what you need to keep context small.</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="p-6 sm:p-8 font-mono text-sm sm:text-base overflow-x-auto">
              <pre className="text-zinc-300">
                <code>
                  ...
                  {'\n'}
                  <span className="text-purple-400">agent-slack</span> message send general <span className="text-green-400">"Hello from the CLI!"</span>
                </code>
              </pre>
            </div>
          </div>
