...
| **Bot support**     | [`agent-slackbot`](/docs/integrations/slackbot) and [`agent-discordbot`](/docs/integrations/discordbot) for server-side and CI/CD |
...
For these use cases, Agent Messenger also supports bot tokens via [`agent-slackbot`](/docs/integrations/slackbot) and [`agent-discordbot`](/docs/integrations/discordbot).
...
- [Discord Bot](/docs/integrations/discordbot) - Bot token integration for server-side and CI/CD
