...
- [Slack Bot Reference](/docs/integrations/slackbot) - Bot token for server-side/CI/CD
- [Discord Reference](/docs/integrations/discord) - Full command reference
- [Discord Bot Reference](/docs/integrations/discordbot) - Bot token for server-side/CI/CD
