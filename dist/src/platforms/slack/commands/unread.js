...
export async function threadsAction(channel, threadTs, options) {
    try {
        const credManager = new CredentialManager();
        const workspace = await credManager.getWorkspace();
        if (!workspace) {
...
export async function markAction(channel, ts, options) {
    try {
        const credManager = new CredentialManager();
        const workspace = await credManager.getWorkspace();
        if (!workspace) {
