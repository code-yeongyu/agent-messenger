...
- Completed at: 2026-06-29T11:42:37Z
- Upstream repo: agent-messenger/agent-messenger
- Upstream branch: main
- Upstream SHA: 76500f055d1b1eb295692400b2ef01cd541b7052
- Merge commit: 9dabec7b merge: sync main with upstream/main
- Upstream pin: .github/upstream.json updated to 76500f055d1b1eb295692400b2ef01cd541b7052 at 2026-06-29T11:40:23Z

## Preserved Fork Commits

Non-merge fork commits present before the upstream merge and preserved in first-parent history:
...
- skills/agent-discord/SKILL.md: frontmatter conflict only. Kept the fork's readonly/personal-token safety description and took upstream's version bump to 2.27.2.

.github/upstream.json had no merge conflict. The fork file was retained and then updated after the merge to the integrated upstream SHA and current UTC sync time.

## QA Results

- bun install --frozen-lockfile: passed, no lockfile changes
- cd docs && bun install --frozen-lockfile: passed, no lockfile changes
- bun run typecheck: passed
- bun run lint: passed, 0 warnings and 0 errors
- bun run format:check: passed, all matched files use the correct format
- bun run test: passed, 3458 pass, 0 fail
- bun run build: passed, updated shebangs in 19 CLI files and copied vendored LINE runtime into dist/src/vendor
- node dist/src/cli.js --help: passed
- node dist/src/cli.js slack --help: passed

## Follow-up Fixes

No focused fix commits were required after QA.
