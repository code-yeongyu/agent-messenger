...
- List operations (`channel list`, `dm list`, `message search`, `snapshot`, etc.) silently filter denied items out. You will never see those entries — do not assume the server is empty.
